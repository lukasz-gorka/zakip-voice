...
>(({side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props}, ref) => {
    ...
    return (
        <div
            ref={ref}
            className="group peer text-sidebar-foreground p-2"
            data-state={state}
        ...
        >
            <div
                className={cn(
                    "flex h-full w-[--sidebar-width] shrink-0 flex-col overflow-hidden bg-card transition-[width] duration-200 ease-linear rounded-lg border-r border-border",
                    "group-data-[collapsible=offcanvas]:w-0 group-data-[collapsible=offcanvas]:border-0",
            ...
            >
                <div
                    data-sidebar="sidebar"
                    className={cn(
                        "flex h-full w-[--sidebar-width] min-w-[--sidebar-width] flex-col bg-transparent",
